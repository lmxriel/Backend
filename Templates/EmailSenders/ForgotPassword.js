...
// ENV VARIABLES (reuse gmailClient.js or copy)
...
exports.forgotPasswordOtpEmail = async function ({
  to,
  userName,
  otp,
  expiresInSeconds,
  ...
  const templatePath = path.join(
    __dirname,
    "../ComposedEmails/ForgotPasswordOtp.html"
  );
  ...
  const data = await sendGmail({
    to,
    subject: "PawfectCare Password Reset Code",
    html: htmlContent,
  });
  return data;
};
